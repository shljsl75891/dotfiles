...
globalkeys = mytable.join( -- Destroy all notifications
   ...
   -- }),
    ...
    awful.key({}, "XF86AudioRaiseVolume", function()
        os.execute(string.format("amixer sset 'Master' 2%%+",
        ...
        os.execute(string.format("amixer sset 'Master' toggle", beautiful.volume
...
awful.spawn.with_shell(
    "xinput set-prop \"SYNA3255:00 06CB:7F28 Touchpad\" \"libinput Tapping Enabled\" 1&")
awful.spawn.with_shell(
