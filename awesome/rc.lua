...
globalkeys = mytable.join(
    ...
    awful.key({}, "XF86AudioRaiseVolume",
        function ()
            os.execute(string.format("amixer sset 'Master' 2%%+", beautiful.volume.channel))
    ...
    --]]
    -- Prompt
    awful.key({ modkey },"r",     function () awful.util.spawn("dmenu_run -fn 'SF Pro Display-11' -nb '#000000' -nf '#aaaaaa' -sf '#000000' -sb '#6272a4'") end,
